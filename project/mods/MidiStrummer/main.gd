...
# takes an array of notes in format [string, fret] provided by _get_possible_notes()
...
func _get_best_note(notes: Array) -> Array:
	var best_note: Array
...
func _update_string_queue(last_played_string: int) -> void:
